            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST"
                          action="{{route('postUpdateStudent')}}">
                        {{ csrf_field() }}
                            ...
                            <div class="col-md-4 form-group{{ $errors->has('admission_no') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group margin-bottom-sm">
                                        <span id="adclick" class="input-group-addon"><i class="fa fa-search"></i></span>
                                        {!! Form::text('search_text', null,array('placeholder' =>'Search No','name'=>'adNo','required','class' => 'form-control','id'=>'adNo')) !!}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row center-block"
                            ...
                            <div class="col-md-6 form-group{{ $errors->has('First_name') ? ' has-error' : '' }}">
                                <label for="First_name" class="col-md-4 control-label">Student's First name</label>

                                <div class="col-md-8">
                                    <div class="input-group margin-bottom-sm">
                                        <span class="input-group-addon"><i class="fa fa-search"></i></span>
                                        <input id="First_name" type="text" class="form-control"
                                               placeholder="Search Name" name="First_name"
                            ...
                            <div class="col-md-6 form-group{{ $errors->has('Last_name') ? ' has-error' : '' }}">
                                <label for="Last_name" class="col-md-4 control-label">Student's Last Name</label>
