...
@section('title','Cambridge School | Admission & Refundable')
...
@section('plugins')
    ...
    <link href="{{asset('/css/admission&refund.css') }}" rel="stylesheet" type="text/css">
...
@section('content')
    @include('auth.logout')
    @include('Activities.Revenue.Admission&RefFrm')
...
@section('script')
    ...
    <script type="text/javascript" src="{{asset('/js/fillAdmissionRefund.js')}}"></script>
    <script>
